var englishcorpus=[["John ate an apple before afternoon","before afternoon John ate an apple","John before afternoon ate an apple"],
...
var hindicorpus=[["राम और श्याम बाजार गयें","राम और श्याम गयें बाजार","बाजार गयें राम और श्याम","गयें बाजार राम और श्याम"],
...
function language(){
    document.getElementById("p1").innerHTML="<b>Form a sentence (Declarative or Interrogative or any other type) from the given word</b><br>(select the buttons in proper order)";
...
function reform(wr,index,corpus){
    ...
    ref_but.style.margin="0px 5px";

    chk_but=document.createElement("input");
    chk_but.type="button";
    chk_but.value="Check correctness of the sentence";
